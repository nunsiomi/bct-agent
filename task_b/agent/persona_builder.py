...
Mirrors `task_a/agent/persona_builder.py`. The body is identical; only the
...
{{
  ...
  "category_affinity": list of short lowercase tags (e.g. ["movies","thriller","nollywood"]),
  "nigerian_markers": list of cultural cues detected in the persona text (e.g. ["lagos","pidgin","nollywood"])
}}
