"""Nigerian-context node -- deduped across Task A and Task B.

Layers cultural / linguistic / market context onto state. Reads
`fingerprint` + `persona`; writes `nigerian_context`,
`nigerian_context_applied`, `language_region`.
"""
...
def nigerian_context_node(state: dict[str, Any]) -> dict[str, Any]:
